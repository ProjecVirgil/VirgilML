...
class ML:
    def __init__(self) -> None:
            ...
            testing_dirty = "data/data_test/Dataset_TestingW.csv"
            ...
            self.predictions = self.rf_model.predict(self.test_features)
    ...
    def prevision(self, command: str):
        ...
        predicted_context2 = self.rf_model.predict(example_features)
        # Fai una previsione utilizzando il modello RandomForestClassifier
        predicted_probs = self.rf_model.predict_proba(example_features)[0]
